...
const MovieDetail = () => {
  ...
  const { detailMovie, detailReviews, detailRelated, detailVideo, genreList, loading } = useSelector(state => state.movie);
              ...
              <Row>
                <Col xl="12" lg="12" className="mb-50 mt-50 detail-info-bottom">
                  ...
                  >
                    ...
                    >
                      {
                        readyData ? <RelatedMovies detailRelated={detailRelated} genreList={genreList} loading={loading} /> : ""
                      }
                    </Tab>
                  </Tabs>
                </Col>
